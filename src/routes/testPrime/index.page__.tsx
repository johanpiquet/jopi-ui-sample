                            ...
                            <div id="app-sidebar-2"
                                ...
                                <div className="flex flex-column h-full">
                                    ...
                                    <span className="inline-flex align-items-center gap-2">
                                        ...
                                        <span>
                                        <Button type="button" ref={closeIconRef as Ref<Button>} onClick={(e) => hide(e)}
                                    ...
                                    <div className="overflow-y-auto">
                                        <ul className="list-none p-3 m-0">
                                            <li>
                                                <StyleClass nodeRef={btnRef1} selector="@next"
                                                ...
                                                <ul className="list-none p-0 m-0 overflow-hidden">
                                                    ...
                                                    <li>
                                                        <StyleClass nodeRef={btnRef2} selector="@next"
                                        ...
                                        <ul className="list-none p-3 m-0">
                                            <li>
                                                <StyleClass nodeRef={btnRef4} selector="@next"
                                                            enterFromClassName="hidden" enterActiveClassName="slidedown"
                                                            leaveToClassName="hidden" leaveActiveClassName="slideup">
                                                    <div ref={btnRef4}
                                                         className="p-ripple p-3 flex align-items-center justify-content-between text-600 cursor-pointer">
